...
const slides = [
  {
    ...
    headline: "Africa's Intelligent Health Infrastructure",
    sub: "Turning fragmented health data into real-time intelligence — built for governments, hospitals, and health systems across the continent.",
  ...
  {
    tag: 'The Challenge · The Opportunity',
    headline: "Health Data Exists. The Systems Don't.",
    sub: "Africa carries 25% of the global disease burden yet receives less than 1% of health AI investment. We close that gap.",
    cta1: { label: 'See the Challenge', href: '#challenge' },
    cta2: { label: 'Our Approach', href: '#about' },
    stat: '408M+', statLabel: 'People without adequate healthcare access',
    visual: 'map',
  },
  {
    tag: 'Invest · Partner · Collaborate',
    headline: "The Window to Lead Is Now Open",
    sub: "41 of 54 African countries have digital health strategies. AiVantha builds the intelligence layer that makes them real.",
    cta1: { label: 'Get in Touch', href: '#contact' },
    cta2: { label: 'View Products', href: '#solutions' },
...
const MapVisual = () => (
  <svg viewBox="0 0 480 380" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.vizSvg}>
    ...
    <path d="M200,30 L260,20 L310,35 L345,65 L360,105 L368,150 L362,195 L350,230 L330,262 L305,288 L275,310 L250,330 L232,340 L215,328 L200,305 L182,275 L168,245 L158,215 L150,185 L148,155 L152,120 L160,88 L172,60 Z" fill="rgba(0,74,173,.12)" stroke="rgba(0,74,173,.4)" strokeWidth="1.5"/>
    {[
      { cx: 272, cy: 210, color: '200,150,12', size: 10 },
      { cx: 195, cy: 195, color: '0,74,173',   size: 9  },
      { cx: 300, cy: 100, color: '16,185,129', size: 8  },
      { cx: 268, cy: 295, color: '200,150,12', size: 8  },
      { cx: 165, cy: 155, color: '0,74,173',   size: 7  },
      { cx: 220, cy: 240, color: '16,185,129', size: 7  },
    ...
    {[[272,210,195,195],[272,210,220,240],[272,210,268,295],[195,195,165,155],[195,195,220,240],[300,100,272,210]].map(([x1,y1,x2,y2],i) => (
...
const ChartVisual = () => (
  <svg viewBox="0 0 480 360" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.vizSvg}>
    ...
    {[{x:80,h1:140,h2:92},{x:150,h1:160,h2:108},{x:220,h1:180,h2:120},{x:290,h1:200,h2:140},{x:360,h1:178,h2:124},{x:430,h1:210,h2:148}].map(({x,h1,h2},i) => (
      <g key={i}>
